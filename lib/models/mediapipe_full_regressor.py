...
class MediapipeFullRegressor(Basic):
    def __init__(self, cfg, **kwargs):
        super(MediapipeFullRegressor, self).__init__()
        ...
        self.landmarks = nn.Linear(
            output_channel, self.num_joints * (self.num_dims - 1)
        )
...
def get_pose_net(cfg, is_train, **kwargs):
    model = MediapipeFullRegressor(cfg, **kwargs)
