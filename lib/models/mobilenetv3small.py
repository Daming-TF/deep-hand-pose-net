    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.root = nn.Sequential(
            ...
            Block(
                ...
                semodule=SeModule(in_size=int(16 * self.alpha)),
                stride=2,
            ),
        )  # 1/4
        ...
        self.stage3 = nn.Sequential(
            ...
            Block(
                ...
                out_size=int(48 * self.alpha),
                nolinear=Hswish(),
                semodule=SeModule(in_size=int(48 * self.alpha)),
                stride=1,
            ),
            Block(
                kernel_size=5,
                in_size=int(48 * self.alpha),
                expand_size=int(144 * self.alpha),
                out_size=int(48 * self.alpha),
                nolinear=Hswish(),
                semodule=SeModule(in_size=int(48 * self.alpha)),
                stride=1,
        ...
        self.stage4 = nn.Sequential(
            Block(
                kernel_size=5,
                in_size=int(48 * self.alpha),
                expand_size=int(288 * self.alpha),
                out_size=int(96 * self.alpha),
                nolinear=Hswish(),
                semodule=SeModule(in_size=int(96 * self.alpha)),
                stride=2,
            ),
            Block(
                kernel_size=5,
                in_size=int(96 * self.alpha),
                expand_size=int(576 * self.alpha),
                out_size=int(96 * self.alpha),
                nolinear=Hswish(),
                semodule=SeModule(in_size=int(96 * self.alpha)),
                stride=1,
            ...
            nn.Conv2d(
                in_channels=int(96 * self.alpha),
                out_channels=int(576 * self.alpha),
                kernel_size=1,
                stride=1,
                padding=0,
                bias=False,
            ),
            nn.BatchNorm2d(int(576 * self.alpha)),
            Hswish(),
        )
...
def get_pose_net(cfg, is_train, **kwargs):
    model = MobileNetV3Small(cfg, **kwargs)
